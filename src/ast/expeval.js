...
var astclasses = astclasses || require('./ast');
...
astclasses.PowerExp.prototype.eval = function (cxt) {
    return Math.pow(this.e1.eval(cxt), this.e2.eval(cxt));
};

astclasses.ModuloExp.prototype.eval = function (cxt) {
    return this.e1.eval(cxt) % this.e2.eval(cxt);
};
...
astclasses.Float.prototype.eval = function (cxt) {
    return this.value;
};
